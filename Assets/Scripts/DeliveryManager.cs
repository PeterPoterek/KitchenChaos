...
public class DeliveryManager : MonoBehaviour
{
 ...
 private int succuessfulRecipesAmount;
 ...
 private void Update()
 {
  ...
  if (spawnRecipeTimer <= 0)
  {
   ...
   if (KitchenGameManger.Instance.IsGamePlaying() && waitingRecipeSOList.Count < waitingRecipeMax)
   {
 ...
 {
  return succuessfulRecipesAmount;
 }
}
